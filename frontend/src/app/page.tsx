        ...
        <>
            ...
            onClick={() => {
              ...
              if (respond) {
                setSandBoxPortfolio([
                  ...
                  {
                    performanceData:
                      args?.investment_summary?.performanceData.map(
                        (item: any) => ({
                          date: item.date,
                ...
                respond(
                  "Data rendered successfully. Provide summary of the investments"
                );
              }
            }}>
            Accept
          ...
          <button
            ...
            onClick={() => {
              ...
              if (respond) {
                respond(
                  "Data rendering rejected. Just give a summary of the rejected investments"
                );
              }
            }}>
            Reject
